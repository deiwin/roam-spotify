...
(function($PS) {
  ...
  exports["monadEffectFreeT"] = monadEffectFreeT;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  ...
  var functorCoTransform = {
      map: Data_Bifunctor.rmap(bifunctorCoTransform)
  };
...
(function($PS) {
  ...
  var takeFive = (function () {
      var go = function (acc) {
          return Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorCoTransform)(Effect_Aff.monadAff))(Control_Coroutine.cotransform(Effect_Aff.monadAff)(acc))(function (o) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorCoTransform)(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorCoTransform))(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log(o))))(function () {
                  return go(Data_List.take(5)(new Data_List_Types.Cons(o, acc)));
              });
          });
      };
      return go(Data_List_Types.Nil.value);
  ...
  var keydownProducer = function (dictMonadAff) {
      var emitKeyboardEvent = function (emitter) {
          return function (event) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return Control_Coroutine_Aff.emit(emitter)(v.value0);
              };
              throw new Error("Failed pattern match at Main (line 73, column 37 - line 75, column 53): " + [ v.constructor.name ]);
          };
      };
      return Control_Coroutine_Aff["produce'"](dictMonadAff)(function (emitter) {
          return function __do() {
              ...
              var listener = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Web_Event_EventTarget.eventListener(emitKeyboardEvent(emitter)))();
              return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Web_Event_EventTarget.addEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(listener)(false)(target))();
          };
      });
  };
  ...
  var runProgram = function (dictDiscard) {
      return function (program) {
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Spotify_Auth.withToken(config))(function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 93, column 5 - line 95, column 44): " + [ result.constructor.name ]);
          }));
      };
  };
  var main = (function () {
      var consumer = Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorAwait)(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))))(Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))))(Control_Coroutine["await"](Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))))(function (keyboardEvent) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))))(Effect_Class.liftEffect(Control_Monad_Free_Trans.monadEffectFreeT(Control_Coroutine.functorAwait)(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff))))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(keyboardEvent))))(function () {
              return Effect_Class.liftEffect(Control_Monad_Free_Trans.monadEffectFreeT(Control_Coroutine.functorAwait)(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff))))(Effect_Console.log(Web_UIEvent_KeyboardEvent.key(keyboardEvent)));
          });
      }));
      return runProgram(Control_Bind.discardUnit)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Control_Coroutine.runProcess(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Except_Trans.monadRecExceptT(Effect_Aff.monadRecAff)))(Control_Coroutine.connect(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Except_Trans.monadRecExceptT(Effect_Aff.monadRecAff)))(Control_Parallel_Class.monadParReaderT(Control_Parallel_Class.monadParExceptT(Effect_Aff.parallelAff)))(keydownProducer(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))))(consumer)))(function () {
  ...
  exports["config"] = config;
  exports["main"] = main;
  exports["takeFive"] = takeFive;
  exports["keydownProducer"] = keydownProducer;
