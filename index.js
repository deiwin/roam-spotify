...
(function($PS) {
  ...
  var getFocusedBlockMetadata = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))($foreign["_getFocusedBlockMetadata"](Data_Maybe.Just.create)(Data_Maybe.Nothing.value)))(function (blockJsonMaybe) {
      ...
      throw new Error("Failed pattern match at Roam (line 29, column 3 - line 36, column 28): " + [ blockJsonMaybe.constructor.name ]);
  });
  var decodeJsonBlock = {
      decodeJson: function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (obj) {
...
(function($PS) {
  ...
  var runProgram = function (dictDiscard) {
      return function (program) {
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Spotify_Auth.withToken(config))(function (v) {
              ...
              throw new Error("Failed pattern match at Main (line 46, column 5 - line 48, column 44): " + [ result.constructor.name ]);
          }));
      };
  };
  var main = runProgram(Control_Bind.discardUnit)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Spotify.togglePlayback)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Spotify.togglePlayback)(function () {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.mapExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff))(Roam.getFocusedBlockMetadata)))(function (maybeFocusedBlockMetadata) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff)))(Effect_Console.logShow(Data_Maybe.showMaybe(Roam.showFocusedBlockMetadata))(maybeFocusedBlockMetadata)))(function () {
                  if (maybeFocusedBlockMetadata instanceof Data_Maybe.Nothing) {
                      return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff)))(Effect_Console.log("No block is focused"));
                  };
                  if (maybeFocusedBlockMetadata instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.mapExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff))(Roam.findBlock(maybeFocusedBlockMetadata.value0.value0.blockUid))))(function (focusedBlock) {
                  ...
                  throw new Error("Failed pattern match at Main (line 32, column 5 - line 36, column 42): " + [ maybeFocusedBlockMetadata.constructor.name ]);
              });
          });
      });
  }));
