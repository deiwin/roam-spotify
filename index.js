...
(function($PS) {
  ...
  var produce$prime = function (dictMonadAff) {
      var $14 = Control_Monad_Free_Trans.hoistFreeT(Control_Coroutine.functorEmit)(((((dictMonadAff.MonadEffect0()).Monad0()).Bind1()).Apply0()).Functor0())(Effect_Aff_Class.liftAff(dictMonadAff));
      return function ($15) {
          return $14(produce($15));
      };
  };
  var emit = function (v) {
      return function ($16) {
...
(function($PS) {
  "use strict";
  $PS["KeyboardShortcuts"] = $PS["KeyboardShortcuts"] || {};
  var exports = $PS["KeyboardShortcuts"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Control_Coroutine = $PS["Control.Coroutine"];
  ...
  var shortcuts = new Data_List_Types.Cons(new Data_NonEmpty.NonEmpty("F13", new Data_List_Types.Cons("p", Data_List_Types.Nil.value)), new Data_List_Types.Cons(new Data_NonEmpty.NonEmpty("F13", new Data_List_Types.Cons("l", Data_List_Types.Nil.value)), Data_List_Types.Nil.value));
  var keydownEmitter = (function () {
      var eventEmitter = Halogen_Subscription.makeEmitter(function (emit) {
          return function __do() {
              var target = Data_Functor.mapFlipped(Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))(Web_HTML_HTMLDocument.toEventTarget)();
              var domEventListener = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Web_Event_EventTarget.eventListener(emit))();
              Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Web_Event_EventTarget.addEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(domEventListener)(false)(target))();
              return Web_Event_EventTarget.removeEventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(domEventListener)(false)(target);
          };
      });
      return Data_Functor.map(Halogen_Subscription.functorEmitter)(Data_Maybe.fromJust())(Halogen_Subscription.filter(Data_Maybe.isJust)(Data_Functor.map(Halogen_Subscription.functorEmitter)(Web_UIEvent_KeyboardEvent.fromEvent)(eventEmitter)));
  })();

  // TODO how/when to unsubscribe?
  // liftEffect $ HS.unsubscribe subscription
  var shortcutEmitter = (function () {
      var minShortcutLength = Data_Maybe.fromMaybe(1)(Data_Foldable.minimum(Data_Ord.ordInt)(Data_List_Types.foldableList)(Data_Functor.mapFlipped(Data_List_Types.functorList)(shortcuts)(Data_Foldable.length(Data_List_Types.foldableNonEmptyList)(Data_Semiring.semiringInt))));
      var maxShortcutLength = Data_Maybe.fromMaybe(1)(Data_Foldable.maximum(Data_Ord.ordInt)(Data_List_Types.foldableList)(Data_Functor.mapFlipped(Data_List_Types.functorList)(shortcuts)(Data_Foldable.length(Data_List_Types.foldableNonEmptyList)(Data_Semiring.semiringInt))));
      var matchesShortcut = function (events) {
          return Data_Foldable.any(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Foldable.all(Data_List_Types.foldableList)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Tuple.uncurry(Data_Eq.eq(Data_Eq.eqString))))(Data_Functor.mapFlipped(Data_List_Types.functorList)(shortcuts)((function () {
              var $6 = Data_Functor.map(Data_List_Types.functorList)(Data_Bifunctor.bimap(Data_Bifunctor.bifunctorTuple)(Web_UIEvent_KeyboardEvent.key)(Control_Category.identity(Control_Category.categoryFn)));
              var $7 = Data_List.zip(events);
              return function ($8) {
                  return $6($7(Data_List.reverse(Data_List_NonEmpty.toList($8))));
              };
          })()));
      };
      var fastEnough = function (events) {
          return Data_Maybe.fromMaybe(false)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_List.head(events))(function (lastEvent) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_List.last(events))(function (firstEvent) {
                  var diff = Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(Data_DateTime_Instant.unInstant(Web_Event_Event.timeStamp(Web_UIEvent_KeyboardEvent.toEvent(lastEvent))))(Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds)(Data_DateTime_Instant.unInstant(Web_Event_Event.timeStamp(Web_UIEvent_KeyboardEvent.toEvent(firstEvent)))));
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Ord.lessThan(Data_Time_Duration.ordMilliseconds)(diff)(Data_Time_Duration.fromDuration(Data_Time_Duration.durationSeconds)(1.0)));
              });
          }));
      };
      return Halogen_Subscription.filter(fastEnough)(Halogen_Subscription.filter(matchesShortcut)(Halogen_Subscription.filter((function () {
          var $9 = Data_Foldable.length(Data_List_Types.foldableList)(Data_Semiring.semiringInt);
          return function ($10) {
              return (function (v) {
                  return v >= minShortcutLength;
              })($9($10));
          };
      })())((function (emitter) {
          return Halogen_Subscription.fold(function (x) {
              return function (acc) {
                  return Data_List.take(maxShortcutLength)(new Data_List_Types.Cons(x, acc));
              };
          })(emitter)(Data_List_Types.Nil.value);
      })(keydownEmitter))));
  })();
  var shortcutProducer = function (dictMonadAff) {
      return Control_Coroutine_Aff["produce'"](dictMonadAff)(function (emitter) {
          return Data_Functor["void"](Effect.functorEffect)(Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Subscription.subscribe(shortcutEmitter)(Control_Coroutine_Aff.emit(emitter))));
      });
  };
  var subscribeToShortcuts = function (dictMonadRec) {
      return function (dictParallel) {
          return function (dictMonadAff) {
              return function (action) {
                  var consumer = Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorAwait)((dictMonadAff.MonadEffect0()).Monad0()))(Control_Bind.bind(Control_Monad_Free_Trans.bindFreeT(Control_Coroutine.functorAwait)((dictMonadAff.MonadEffect0()).Monad0()))(Control_Coroutine["await"]((dictMonadAff.MonadEffect0()).Monad0()))(function (event) {
                      return Control_Monad_Trans_Class.lift(Control_Monad_Free_Trans.monadTransFreeT(Control_Coroutine.functorAwait))((dictMonadAff.MonadEffect0()).Monad0())(action(event));
                  }));
                  return Control_Coroutine.runProcess(dictMonadRec)(Control_Coroutine.connect(dictMonadRec)(dictParallel)(shortcutProducer(dictMonadAff))(consumer));
              };
          };
      };
  };
  exports["subscribeToShortcuts"] = subscribeToShortcuts;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var note = function (dictMonadThrow) {
      return function (e) {
          return function (v) {
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Error_Class.throwError(dictMonadThrow)(e);
              };
              if (v instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure((dictMonadThrow.Monad0()).Applicative0())(v.value0);
              };
              throw new Error("Failed pattern match at Roam (line 99, column 10 - line 101, column 19): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var getFocusedBlockMetadata = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))($foreign["_getFocusedBlockMetadata"](Data_Maybe.Just.create)(Data_Maybe.Nothing.value)))(function (blockJsonMaybe) {
      ...
      throw new Error("Failed pattern match at Roam (line 53, column 3 - line 60, column 28): " + [ blockJsonMaybe.constructor.name ]);
  });
  var decodeJsonBlock = {
      decodeJson: function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (obj) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(obj)("id"))(function (id) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(obj)("string"))(function (string) {
  ...
  var findBlock = function (uid) {
      var extractBlock = function (result) {
          return Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Data_Either.monadEither))((function () {
              if (result.length === 0) {
                  return Control_Plus.empty(Control_Monad_Maybe_Trans.plusMaybeT(Data_Either.monadEither));
              };
              if (result.length === 1) {
                  return Control_Applicative.pure(Control_Monad_Maybe_Trans.applicativeMaybeT(Data_Either.monadEither))(result[0]);
              };
              return Control_Monad_Error_Class.throwError(Control_Monad_Maybe_Trans.monadThrowMaybeT(Control_Monad_Error_Class.monadThrowEither))("Expecting a single block as a result");
          })())(function (blockResult) {
              if (blockResult.length === 0) {
                  return Control_Monad_Error_Class.throwError(Control_Monad_Maybe_Trans.monadThrowMaybeT(Control_Monad_Error_Class.monadThrowEither))("Expecting block information in nested array");
              };
              if (blockResult.length === 1) {
                  return Control_Applicative.pure(Control_Monad_Maybe_Trans.applicativeMaybeT(Data_Either.monadEither))(blockResult[0]);
              };
              return Control_Monad_Error_Class.throwError(Control_Monad_Maybe_Trans.monadThrowMaybeT(Control_Monad_Error_Class.monadThrowEither))("Expecting a single element in nested array");
          }));
      };
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))($foreign["_findBlock"](uid)))(function (json) {
          return Control_Monad_Except_Trans.except(Effect.applicativeEffect)(Control_Bind.bind(Data_Either.bindEither)(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Data_Argonaut_Decode_Error.printJsonDecodeError)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeArray(decodeJsonBlock)))(json)))(extractBlock));
      });
  };
  var updateBlockString = function (f) {
      return function (uid) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(findBlock(uid))(note(Control_Monad_Except_Trans.monadThrowExceptT(Effect.monadEffect))("Did not find a block with uid: " + uid)))(function (v) {
              var logMetadata = {
                  uid: uid,
                  currentMessage: v.value0.string,
                  newMessage: f(v.value0.string)
              };
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))(Effect_Console.log("Found block to update " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
              ...
              })(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showString))(Data_Show.showString)))(logMetadata))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))($foreign.setBlockString(f(v.value0.string))(uid)))(function () {
                      return Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))(Effect_Console.log("Block updated"));
                  });
              });
          });
      };
  };
  var updateFocusedBlockString = function (f) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(getFocusedBlockMetadata)(note(Control_Monad_Except_Trans.monadThrowExceptT(Effect.monadEffect))("No block is currently focused")))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect.monadEffect))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Class.monadEffectEffect))(Effect_Console.log("Will update focused block with uid " + v.value0.blockUid)))(function () {
              return updateBlockString(f)(v.value0.blockUid);
          });
      });
  };
  exports["updateFocusedBlockString"] = updateFocusedBlockString;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  ...
  var timestamp = function (v) {
      var v1 = Data_Time_Duration.toDuration(Data_Time_Duration.durationHours)(v.value0.progress);
      var v2 = Data_Time_Duration.toDuration(Data_Time_Duration.durationMinutes)(v.value0.progress);
      var v3 = Data_Time_Duration.toDuration(Data_Time_Duration.durationSeconds)(v.value0.progress);
      var leftPad = function (minCount) {
          return function ($$char) {
              return function (string) {
                  if (Data_String_CodePoints.length(string) >= minCount) {
                      return string;
                  };
                  if (Data_Boolean.otherwise) {
                      return (function (v4) {
                          return v4 + string;
                      })(Data_String_CodeUnits.fromCharArray(Data_Function.flip(Data_Array.replicate)($$char)(minCount - Data_String_CodePoints.length(string) | 0)));
                  };
                  throw new Error("Failed pattern match at Spotify (line 86, column 3 - line 86, column 45): " + [ minCount.constructor.name, $$char.constructor.name, string.constructor.name ]);
              };
          };
      };
      var format = function (f) {
          var $22 = leftPad(2)("0");
          var $23 = Data_Show.show(Data_Show.showInt);
          return function ($24) {
              return $22($23(f(Data_Int.round($24))));
          };
      };
      return format(Control_Category.identity(Control_Category.categoryFn))(v1) + (":" + (format(function (v4) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v4)(60);
      })(v2) + (":" + format(function (v4) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v4)(60);
      })(v3))));
  };
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Console = $PS["Effect.Console"];
  var KeyboardShortcuts = $PS["KeyboardShortcuts"];
  var Roam = $PS["Roam"];
  var Spotify = $PS["Spotify"];
  var Spotify_Auth = $PS["Spotify.Auth"];
  var Web_UIEvent_KeyboardEvent = $PS["Web.UIEvent.KeyboardEvent"];                
  var prefixFocusedBlockWithCurTimestamp = Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Spotify.getPlaybackState)(function (playbackState) {
      return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Except_Trans.monadExceptT(Effect_Aff.monadAff))(Data_Function.flip(Control_Monad_Error_Class.catchError(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff)))(function (e) {
          return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Effect_Aff.monadAff))("Failed to update focused block: " + e);
      })(Control_Monad_Except_Trans.mapExceptT(Effect_Class.liftEffect(Effect_Aff.monadEffectAff))(Roam.updateFocusedBlockString(function (s) {
          return Spotify.timestamp(playbackState) + (" " + s);
      }))));
  });
  ...
  var runProgram = function (dictDiscard) {
      return function (program) {
          return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Spotify_Auth.withToken(config))(function (v) {
              return Control_Bind.discard(dictDiscard)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Reader_Trans.runReaderT(program)(v.value0))(function () {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(v.value1);
              });
          })))(function (result) {
              if (result instanceof Data_Either.Left) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.warn("Program failed with: " + result.value0));
              };
              if (result instanceof Data_Either.Right) {
                  return Data_Functor["void"](Effect_Aff.functorAff)(Effect_Aff.joinFiber(result.value0));
              };
              throw new Error("Failed pattern match at Main (line 64, column 5 - line 66, column 44): " + [ result.constructor.name ]);
          }));
      };
  };
  var main = (function () {
      var logErrAndContinue = function (m) {
          return Control_Monad_Error_Class.catchError(Control_Monad_Reader_Trans.monadErrorReaderT(Control_Monad_Except_Trans.monadErrorExceptT(Effect_Aff.monadAff)))(m)(function (e) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff)))(Effect_Console.errorShow(Data_Show.showString)(e)))(function () {
                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff)))(Data_Unit.unit);
              });
          });
      };
      var action = function (event) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(logErrAndContinue(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Spotify.togglePlayback)(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(Spotify.togglePlayback)(function () {
                  return prefixFocusedBlockWithCurTimestamp;
              });
          })))(function () {
              return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff)))(Effect_Console.log(Data_Show.show(Data_List_Types.showList(Data_Show.showString))(Data_Functor.map(Data_List_Types.functorList)(Web_UIEvent_KeyboardEvent.key)(event))));
          });
      };
      return runProgram(Control_Bind.discardUnit)(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff)))(KeyboardShortcuts.subscribeToShortcuts(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Except_Trans.monadRecExceptT(Effect_Aff.monadRecAff)))(Control_Parallel_Class.monadParReaderT(Control_Parallel_Class.monadParExceptT(Effect_Aff.parallelAff)))(Effect_Aff_Class.monadAffReader(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff)))(action))(function () {
          return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Except_Trans.monadEffectExceptT(Effect_Aff.monadEffectAff)))(Effect_Console.log("done"));
      }));
  })();
  exports["config"] = config;
  exports["main"] = main;
  exports["prefixFocusedBlockWithCurTimestamp"] = prefixFocusedBlockWithCurTimestamp;
