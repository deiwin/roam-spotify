...
(function($PS) {
  ...
  var request = function (req) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Effect_Aff_Class.liftAff(Effect_Aff_Class.monadAffExceptT(Effect_Aff_Class.monadAffAff))(Affjax.request(req)))(function (result) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Monad_Except_Trans.except(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Affjax.printError)(result)))(function (response) {
              ...
              throw new Error("Failed pattern match at Spotify (line 175, column 3 - line 178, column 63): " + [ response.status.constructor.name ]);
          });
      });
  };
          ...
          return function (description) {
              return Control_Monad_Except_Trans.mapExceptT(function (v) {
                  return Control_Bind.bind(dictBind)(v)(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Spotify (line 184, column 15 - line 190, column 23): " + [ v1.constructor.name ]);
                  });
              });
          };
      };
  ...
  var getPlaybackState = function (token) {
      var req = {
      ...
      var logResult$prime = logResult(Effect_Aff.bindAff)(Effect_Aff.monadEffectAff)("get playback state");
      return logResult$prime(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(request(req))(function (response) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Control_Applicative.when(Control_Monad_Except_Trans.applicativeExceptT(Effect_Aff.monadAff))(Data_Eq.eq(Affjax_StatusCode.eqStatusCode)(response.status)(204))(Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Effect_Aff.monadAff))("Received empty playback state")))(function () {
              return Control_Monad_Except_Trans.except(Effect_Aff.applicativeAff)(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Data_Argonaut_Decode_Error.printJsonDecodeError)(Data_Argonaut_Decode_Class.decodeJson(decodeJsonPlaybackState)(response.body)));
          });
      }));
  };
  ...
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("\ud83c\udf5d")))(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Effect_Aff.monadAff))(Spotify.getAccessToken(clientID)(clientSecret)(refreshToken))(function (v) {
          ...
          if (s instanceof Data_Either.Right) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log(Data_Show.show(Data_Time_Duration.showMilliseconds)(s.value0.value0.progress))))(function () {
